...
namespace App\Badanie\UzywkiBundle\Form\DataTransformer;

use App\Badanie\UzywkiBundle\Model\Alkohol;
use Symfony\Component\Form\DataTransformerInterface;

class AlkoholTransformer implements DataTransformerInterface
{
    /**
     ...
     * @throws TransformationFailedException0  when the transformation fails
     */
    public function transform($value)
    {
        return new Alkohol($value);
    }
